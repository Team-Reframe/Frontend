...
public final class ActivityScanBinding implements ViewBinding {
  ...
  private ActivityScanBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNavigation, @NonNull FrameLayout scanFragmentContainer) {
    this.rootView = rootView;
    this.bottomNavigation = bottomNavigation;
    this.scanFragmentContainer = scanFragmentContainer;
  }
  ...
  public static ActivityScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.scan_fragment_container;
      FrameLayout scanFragmentContainer = ViewBindings.findChildViewById(rootView, id);
      if (scanFragmentContainer == null) {
        break missingId;
      }

      return new ActivityScanBinding((ConstraintLayout) rootView, bottomNavigation,
          scanFragmentContainer);
    }
